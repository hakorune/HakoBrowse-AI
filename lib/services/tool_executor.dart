...
part 'tool_executor/tool_executor_helpers.dart';
part 'tool_executor/tool_executor_http_handler.dart';
part 'tool_executor/tool_executor_skill_handlers.dart';
  ...
  static Future<String> execute({
    ...
    switch (toolName) {
      case 'load_skill_index':
        return _handleLoadSkillIndexTool(
          arguments: arguments,
          skills: skills,
        );

      case 'load_skill':
        return _handleLoadSkillTool(
          arguments: arguments,
          skills: skills,
        );

      case 'load_skill_file':
        return _handleLoadSkillFileTool(
          arguments: arguments,
          skills: skills,
        );
